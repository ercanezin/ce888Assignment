...
def action_1():
    return np.random.choice([2, -2], p=[0.6, 0.4])
...
def action_3():
    return np.random.choice([100, 0], p=[0.5, 0.5])


def action_4():
    return np.random.choice([2, 0], p=[0.6, 0.4])


def action_5():
    return np.random.choice([-100, 0], p=[0.2, 0.8])


rewards = [action_0, action_1, action_2]

rewards2 = [action_3, action_4, action_5]
